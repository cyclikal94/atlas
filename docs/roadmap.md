...
4. Review and publish the generated archives, image artefacts and Helm chart through
   the chosen release/registry channels. Workflows build reviewable artefacts; they do
   not publish automatically or imply that remote checks have already run.
