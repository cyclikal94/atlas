...
The backend is **pre-release**. Direct host execution supports SQLite or PostgreSQL. Compose, Helm, export/restore and release validation remain in the
[roadmap](docs/roadmap.md). Breaking changes may require an explicit database reset;
...
`127.0.0.1:3000`. See [operations](docs/operations.md) for local database setup.
